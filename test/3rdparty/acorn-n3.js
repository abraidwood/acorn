...
(function(exports) {
  ...
  function makePredicate2(words) {
    ...
    var str = '(function(str) {var map='+JSON.stringify(map)+'; return map[str] && str !== "hasOwnProperty"})';
    return eval(str);
 ...
 // var isKeyword = makePredicate("if function return var null else true for false in new typeof while delete instanceof throw break continue try catch case void switch finally do default debugger with");
  ...
  function readInt(radix, len) {
    ...
    for (;;) {
      ...
      else if (code <= 57 && code >= 48) val = code - 48; // 0-9
      else val = Infinity;
      if (val >= radix) break;
      ++tokPos;
  ...
  function readNumber(ch) {
    ...
    else if (ch !== 48 /*"0"*/ || str.length === 1) val = parseInt(str, 10);
      ...
      if (ch === 92/*"\\"*/) {
        ...
        if (octal) {
          ...
          if (ch === 120/*"x"*/) {
            ...
            switch (ch) {
            case 110/*"n"*/ : str.push(10/*"\n"*/); break;
            case 114/*"r"*/ : str.push(13/*"\r"*/); break;
            case 116/*"t"*/ : str .push(9/*"\t"*/); break;
            case 98/*"b"*/ : str .push(8/*"\b"*/); break;
            case 118/*"v"*/ : str .push(11/*"\u000b"*/); break;
            case 102/*"f"*/ : str .push(12/*"\f"*/); break;
            case 48/*"0"*/ : str .push(0/*"\0"*/); break;
            case 13/*"\r"*/: if (input.charCodeAt(tokPos) === 10/*"\n"*/) ++tokPos;
            case 10/*"\n"*/: break;
...
})(typeof exports === "undefined" ? (window.acornn = {}) : exports);
